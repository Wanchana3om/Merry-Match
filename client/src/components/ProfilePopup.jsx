...
function ProfilePopup(props) {
    ...
    return (
        <div className="flex justify-center items-center fixed z-50 w-full h-auto p-4 bg-black bg-opacity-50 inset-0" onClick={handleCloseProfile}>
            <div className="flex relative max-w-full h-auto bg-white gap-20 pt-14 px-16 pb-20 rounded-3xl" onClick={(event) => event.stopPropagation()}>
